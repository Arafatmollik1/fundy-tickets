                ...
                <form action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('target_amount') is-invalid @enderror" 
                               id="target_amount" name="target_amount" value="{{ old('target_amount', $post->target_amount) }}" 
                    ...
                    @if($post->image)
                        <div class="mb-3">
                            ...
                            <div>
                                <img src="{{ Storage::url($post->image) }}" class="img-thumbnail" style="max-height: 200px;" alt="Current image">
                            </div>
                        </div>
                    @endif
